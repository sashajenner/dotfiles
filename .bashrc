...
if [ "$color_prompt" = yes ]; then
	PS1="\`if [ \$? = 0 ]; then
			echo '${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;36m\]\w\[\033[00m\]\$ ';
		else
			echo '${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\e[01;31m\]\w\[\033[00m\]\$ ';
		fi\`"
else
...
# Place libraries in .R/ instead of R/
