...
static char *copyurlcmd[] = { "/bin/sh", "-c",
    "tmp=$(sed 's/.*│//g' | tr -d '\n' | grep -aEo '(((http|https)://|www\\.)[a-zA-Z0-9.]*[:]?[a-zA-Z0-9./@$&%?$#=_-]*)|((magnet:\\?xt=urn:btih:)[a-zA-Z0-9]*)' | uniq | sed 's/^www./http:\\/\\/www\\./g' ); IFS=; [ ! -z $tmp ] && echo $tmp | dmenu -i -p 'Copy which url?' -l 10 -fn 'monospace:size=15' | tr -d '\n' | xclip -selection clipboard",
    "externalpipe", NULL };
...
#define TERMMOD_MAIN AltMask
#define TERMMOD_BIG_MAIN (TERMMOD_MAIN|ShiftMask)
...
static Shortcut shortcuts[] = {
	...
	{ TERMMOD_MAIN,         XK_Prior,       zoom,           {.f = +1} },
	{ TERMMOD_MAIN,         XK_Next,        zoom,           {.f = -1} },
	{ TERMMOD_MAIN,         XK_Home,        zoomreset,      {.f =  0} },
	{ TERMMOD_MAIN,         XK_u,     		kscrollup,      {.i = -1} },
	{ TERMMOD_MAIN,         XK_d,   		kscrolldown,    {.i = -1} },
	{ TERMMOD_MAIN,         XK_k,          	kscrollup,      {.i =  1} },
	{ TERMMOD_MAIN,         XK_j,        	kscrolldown,    {.i =  1} },
	{ TERMMOD_BIG_MAIN,     XK_K,          	kscrollup,      {.i =  2} },
	{ TERMMOD_BIG_MAIN,     XK_J,        	kscrolldown,    {.i =  2} },
	{ TERMMOD_MAIN,         XK_v,           normalMode,     {.i =  0} },
	{ TERMMOD_MAIN,         XK_w,           opencopied,     {.v = "qutebrowser"} },
	{ TERMMOD_MAIN,			XK_l,           externalpipe,   {.v = openurlcmd } },
	{ TERMMOD_MAIN,         XK_y,           externalpipe,   {.v = copyurlcmd } },
	{ TERMMOD_MAIN,         XK_o,           externalpipe,   {.v = copyoutput } },
};
